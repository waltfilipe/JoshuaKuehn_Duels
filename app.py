...
events_raw = [
    # -------- GAME 1 --------
    ("DUEL LOST", 97.90, 74.74, None), ("DUEL WON", 58.01, 70.09, "videos/sample1.mp4"),
    ("DUEL WON", 61.66, 26.54, None), ("DUEL WON", 49.03, 57.12, None),
    ("DUEL WON", 93.25, 60.11, "videos/sample2.mp4"), ("DUEL WON", 104.22, 66.60, None),
    ("DUEL WON", 107.71, 77.74, None), ("DUEL LOST", 62.33, 66.93, None),
    ("DUEL WON", 86.10, 40.17, None), ("DUEL LOST", 85.60, 66.43, None),
    ("DUEL WON", 78.62, 42.33, None), ("DUEL WON", 74.63, 33.85, None),
    ("DUEL LOST", 85.60, 51.64, None), ("DUEL LOST", 108.21, 25.54, None),
    ...
    ("DUEL LOST", 89.09, 75.24, None), ("DUEL WON", 94.74, 75.08, None),
    ("DUEL WON", 63.66, 21.38, None), ("DUEL LOST", 81.94, 63.11, None),
    ("FOULED", 39.55, 39.67, "videos/sample3.mp4"), ("DUEL LOST", 51.02, 40.00, None),
    ...
    ("DUEL LOST", 48.70, 2.93, None), ("DUEL WON", 59.00, 21.05, None),
